...
public class Glider {
    ...
    public static ValueAnimator glide(Skill skill, float duration, ValueAnimator animator, Animx_BaseEasingMethod.EasingListener ... listeners){
        Animx_BaseEasingMethod t = skill.getMethod(duration);
