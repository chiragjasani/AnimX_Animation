...
public class Animx_SmartAnimation {

    private static final long DURATION = Animx_BaseViewAnimator.DURATION;
    private static final int SlideLength = Animx_BaseViewAnimator.SlideLength;
    private static final boolean Alpha = Animx_BaseViewAnimator.Alpha;
    private static final float HorizontalCenter = Animx_BaseViewAnimator.HorizontalCenter;
    private static final float VerticalCenter = Animx_BaseViewAnimator.VerticalCenter;
    private static final long NO_DELAY = 0;

    private Animx_BaseViewAnimator animator;
    ...
    private Animx_SmartAnimation(AnimationComposer animationComposer) {
    ...
    public static AnimationComposer with(Animx_BaseViewAnimator animator) {
    ...
    public static final class AnimationComposer {
        ...
        private AnimationComposer(Animx_BaseViewAnimator animator) {
        ...
        public SmartAnimationString playOn(View target) {
            this.target = target;
            return new SmartAnimationString(new Animx_SmartAnimation(this).play(), this.target);
        }
    ...
    public static final class SmartAnimationString {
        ...
        private SmartAnimationString(Animx_BaseViewAnimator animator, View target){
            this.target = target;
            this.animator = animator;
        }
    ...
    private Animx_BaseViewAnimator play() {
